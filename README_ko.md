...
비공개 기술 논문에 보고된 최종 평가에서는, 단일 PC에서 약 **9h 10m**이 걸리던 240프레임 씬이 **20대 Deadline Worker**를 사용해 약 **26-32m**에 완료되었습니다.
...
이 저장소에는 공개 문서와 제출 측 도구의 소스 스냅샷이 포함되어 있습니다. 최종 기술 논문은 추후 redaction된 공개 버전이 추가되기 전까지 비공개 참고 자료로 유지됩니다.
...
- 학생들이 실습실에 과밀되어 병목현상이 발생하고 학생들간의 갈등이 커지기도 했습니다.
