...
"""    def open_main_win(self):
        ...
        # 레포의 MEL을 먼저 source (이미 되어 있으면 그냥 넘어감)
        mel.eval('source "//223.194.101.83/deadline_repo/submission/Maya/Main/SubmitMayaToDeadline.mel";')
        mel.eval('source "//223.194.101.83/deadline_repo/submission/Maya/Client/DeadlineMayaClient.mel";')
        # 네 배포본의 엔트리: 창 띄우기
